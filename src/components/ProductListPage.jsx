                                                    ...
                                                    <Menu.Item key={option.name}>
                                                        {({ active }) => (
                                                            <span onClick={() => { dispatch(handleSortChange(option.name)) }} className={classNames(
                                                                option.current ? 'cursor-pointer font-medium text-gray-900' : ' cursor-pointer text-gray-500',
                                            ...
                                            {sorteditem && sorteditem.map((product) => (
                                                <div key={product.id} className="group relative">
                                                    ...
                                                    <div className="mt-4 flex justify-between">
                                                        ...
                                                        <div className='text-sm line-through font-medium text-gray-500'>{product.discountPercentage}%</div>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
